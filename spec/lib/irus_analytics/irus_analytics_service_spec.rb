...
describe IrusAnalytics::IrusAnalyticsService do 
  ...
  describe ".send_analytics" do
    it "enables the required parameters to be set within a hash" do
      params = { date_stamp: "2010-10-17T03:04:42Z", client_ip_address: "127.0.0.1", user_agent: "Mozilla/5.0 (iPad; U; CPU OS 3_2_1 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) Mobile/7B405",
